...
void collectImgData(std::vector<std::vector<float>>& images, std::vector<int>& labels) {
	std::string imgPath = R"(C:\Users\Moez_\source\repos\ahmed2mz_HW4\ahmed2mz_HW4\MNISTnumImages5000_balanced.txt)";
	std::string lblPath = R"(C:\Users\Moez_\source\repos\ahmed2mz_HW4\ahmed2mz_HW4\MNISTnumLabels5000_balanced.txt)";
